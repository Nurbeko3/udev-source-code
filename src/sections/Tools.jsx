    ...
    <section className="bg-[#F4F7FF] pb-[100px]">
      <div className="container mx-auto p-4 md:p-8">
        ...
        <div className="filters pb-[50px] flex flex-wrap gap-2 justify-center md:justify-start">
          <label
            htmlFor="all"
            className="relative h-[42px] flex items-center justify-between mr-[10px]"
            onClick={resetFilter}
          >
            <div className="wrapper w-[24px] h-[24px] flex items-center justify-center rounded-[50%] m-[9px] cursor-pointer">
              <input
                type="radio"
                id="all"
                name="category"
                className="hidden absolute w-0 h-0 real-radio"
                onChange={resetFilter}
              />
              <span className="w-full h-full rounded-[50%] border-[2px] border-[--primary] custom-radio"></span>
            </div>
            {t("tools.all")}
          </label>
          {[
            ...
            <label
              key={category}
              htmlFor={category}
              className="relative h-[42px] flex items-center justify-between mr-[5px]"
