...
const tools = [
  { id: 1, name: "Prometheus", category: "Devops", image: toolImages.Prometheus },
  ...
  { id: 26, name: "PostgreSQL", category: "Backend", image: toolImages.PostgreSQL },
  ...
  { id: 31, name: "Ant Design", category: "Frontend", image: toolImages.AntDesign },
  { id: 32, name: "Gatsby.JS", category: "Frontend", image: toolImages.GatsbyJS },
  ...
  { id: 36, name: "Adobe suite", category: "UX/UI", image: toolImages.Adobesuite },
  ...
  { id: 42, name: "Cassandra", category: "Backend", image: toolImages.Cassandra },
  { id: 43, name: "Sass", category: "Frontend", image: toolImages.Sass },
  { id: 44, name: "Material UI", category: "Frontend", image: toolImages.MaterialUI },
      ...
      <div className="container mx-auto p-4 md:p-8">
        ...
        <div className="filters pb-[50px] flex flex-wrap gap-2 justify-center md:justify-start">
          <button
            className={`outline-none cursor-pointer py-2 px-4 ${
              activeCategory === null ? "bg-[#A8BFFF] text-white" : "bg-white text-primary"
            } rounded-md`}
            onClick={resetFilter}
          >
            {t("tools.all")}
          </button>
          {["Frontend", "Backend", "Devops", "Testing", "UX/UI", "Infrastructure", "Mobile"].map((category) => (
            <button
              key={category}
              className={`outline-none cursor-pointer py-2 px-4 sort-btn ${
                activeCategory === category ? "bg-[#A8BFFF] text-white" : "bg-white text-primary"
              } rounded-md`}
        ...
        <div className="tools-grid grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
          {tools.map((tool) => (
            <ToolsCard
              key={tool.id}
              color={activeCategory === tool.category || activeCategory === null ? "#A8BFFF" : "white"}
              img={tool.image}
              title={tool.name}
              height={100}
            />
